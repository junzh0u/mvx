...
just deploy-linux <host>       # Cross-compile for Linux x86_64 and scp to host
```
...
- **Context struct**: `Ctx<'a>` bundles session state (`moc`, `force`, `dry_run`, `mp`, `ctrlc`) and is threaded through the call stack
